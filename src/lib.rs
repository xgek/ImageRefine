...
#[derive(Debug)]
pub struct ImageRefineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ImageRefineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ImageRefine processing");
    
    let mut processor = ImageRefineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ImageRefineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ImageRefineProcessor::new(false);
